...
- co zmieniono:
- dlaczego:
- wpływ na konfigurację, wdrożenie lub zachowanie:

## Weryfikacja

- wykonane polecenia i ich wynik:
- testy pominięte wraz z uzasadnieniem:
...
- [ ] Jeśli jest to wkład zewnętrzny wymagający CLA, opublikowałem wymagany komentarz akceptacyjny.
- [ ] Jeśli zmiana dotyczy Mobile, opisałem wynik na Androidzie i iOS albo uzasadniłem pominięcie platformy.
- [ ] Jeśli zmiana dotyczy Mobile, sprawdziłem wpływ na uprawnienia, prywatność, dostępność, White-Label i cleanup danych.
